...
const Input = ({icon: Icon, event: click, ...props}) => {
  return (
    <div className="relative mb-5 bg-transparent">
        ...
        <input {...props} className="w-full pl-10 pr-24 py-4 bg-transparent text-white bg-opacity-50 rounded-xl border-gray-700  placeholder-gray-400 transition duration-200 focus:ring-2 focux:border-green-500 focus:ring-green-500 outline-none border-2 border-solid" />
    </div>
  )
}
