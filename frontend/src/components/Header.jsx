...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-between px-10 py-2 bg-black text-white">
      ...
      {/* Navigation Links */}
      {user ? <button onClick={handleLogout} className="px-4 py-2 bg-emerald-500 text-black font-semibold rounded-md">Logout</button> :       <div className="flex items-center gap-8">
        <Link
